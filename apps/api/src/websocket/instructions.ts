...
id: product ID (very important, this ID will be the one that goes in productsIds).
...
“productsIds”: Array of objects, each containing “productId”, “quantity”, and “detail” (optional).
“typeOrder”: “delivery”.
“total”: Calculated numeric value.
“message”: Message notifying the user that their delivery is ready.
Example of text response: { "ok": true, "direction": "Street 123, City, Country", "productsIds": [{"productId": 1, "quantity": 1, "detail": ""}, {"productId": 2, "quantity": 3, "detail": ""}], "typeOrder": "delivery", "total": 150, "message": "Your delivery is ready to be delivered." }

----- Pick Up Order Required fields:

“productsIds”: Array of objects with “productId”, “quantity” and “detail”.
“date”: Date and time in “YYYY-MM-DD HH:MM” format.
“typeOrder”: “pick_up”.
“total”: Calculated numeric value.
“message”: Message notifying the user that their pick up order is ready.
Example of text response: { "ok": true, "productsIds": [{"productId": 6, "quantity": 1, "detail": ""}, {"productId": 2, "quantity": 1, "detail": ""}], "date": "2025-02-15 18:30", "typeOrder": "pick_up", "total": 150, "message": "Your pick-up order is ready for 18:30." }
...
Example of text response: { "ok": true, "date": "2025-02-16 20:00", "tableId": 12, "typeOrder": "dine_in", "message": "Your reservation for dinner is confirmed for 20:00." }
