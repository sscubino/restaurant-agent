...
Example of text response: { "ok": true, "address": "Street 123, City, Country", "productsIds": [{"productId": 1, "quantity": 1, "detail": ""}, {"productId": 2, "quantity": 3, "detail": ""}], "type": "delivery", "total": 150, "message": "Your delivery is ready to be delivered." }
...
Example of text response: { "ok": true, "productsIds": [{"productId": 6, "quantity": 1, "detail": ""}, {"productId": 2, "quantity": 1, "detail": ""}], "date": "2025-02-15 18:30", "type": "pick_up", "total": 150, "message": "Your pick-up order is ready for 18:30." }
