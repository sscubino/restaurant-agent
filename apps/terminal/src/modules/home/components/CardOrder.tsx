...
const CardOrder = ({ orderData, deleteOrder }: ICardOrder) => {
  ...
  return (
    <div className="w-full flex flex-col ">
      <div className="w-full text-[14px] px-[20px] py-[16px] grid grid-cols-[50px_1fr_1fr_1fr_1fr_1fr_2fr] text-center border-b border-b-gray-200 text-gray-900">
        ...
        <div className="flex flex-row items-center justify-end w-full">
          <button
            ...
            className="h-[20px] w-[20px] flex flex-row items-center justify-center rounded-full bg-gray-400"
          >
            {expanded ? (
      ...
      {expanded && (
        <div className="w-full py-[12px] bg-white flex flex-col items-center justify-center border-b-gray-200 border-b-[1px]">
              ...
              <div className="flex flex-col items-start gap-[6px]">
                ...
                {orderData.tableId && (
                  <div className=" flex flex-row items-center gap-[12px]">
                    ...
                    <p>
                      Table: {orderData.tableId.name} (Capacity:
                      {orderData.tableId.capacity})
                    </p>
                  </div>
                )}
                {orderData.direction && (
              ...
              <div className="flex flex-col w-full my-[20px]">
                ...
                {orderData.productOrder.map((eleemnt, index) => {
                  return (
                    <div
                      key={index}
                      className="w-full grid grid-cols-[40%_20%_20%_20%] border-b-[1px] text-gray-900 font-medium border-gray-200"
                    >
                      <div className="p-3 flex items-center">
                        <p>
                          {eleemnt.dish.name}{" "}
                          {eleemnt.detail && "(" + eleemnt.detail + ")"}
                        </p>
                      </div>
                      <div className="p-3 flex items-center justify-center">
