...
const CardTable = ({ data, changeStatusTable, toggleSelect, isSelected, isSelectionMode }: ICardTable) => {
    const bg = data.availability ? "#33b49b" : "#d3d3d3";
    ...
    return (
        ...
        >
            <div style={{ background: bg }} className="w-[60px] h-[10px] rounded-full"></div>
            <div className="flex flex-row items-center gap-[4px]">
                <div style={{ background: bg }} className="w-[10px] h-[60px] rounded-full"></div>
                <div style={{ background: bg }} className="w-[70px] shadow-md h-[70px] rounded-md flex flex-row items-center justify-center">
